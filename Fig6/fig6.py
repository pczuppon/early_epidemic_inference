...
################################ Plot
################################
tplot = np.arange(0,hosp_time_avg+10,dt)
avg_hosp = scale_hosp*shape_hosp

tplot_Jombart = np.arange(hosp_time_avg-avg_hosp,hosp_time_avg+10,dt)
...
#plt.plot(t,[I_we]*len(t),color='C0',linewidth=2,linestyle='dashed')
