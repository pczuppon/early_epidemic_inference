...
// g++ -std=c++11 00_aux.cpp `pkg-config --libs gsl` command for compiling
...
// R0 distribution
#define kappa 0.58                      // dispersion parameter
#define R0 3.                      // mean number of secondary infections
...
int main(int argc,char *argv[])
{
    ...
    double gsl_ran_gamma_pdf(double x, double a, double b);           // a = scale, b = shape
    ...
    ofstream file ("infectivity.txt", ios::app);
