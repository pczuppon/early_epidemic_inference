...
% include your tikz code here
   		...
   		\begin{scope}[x=(Bild.south east),y=(Bild.north west)]
        	...
        	%\draw (0.7,0.65) node {\includegraphics[scale=0.15]{fig4a_scatter.pdf}};
        	...
        	\draw[color = nb, very thick,dashed] (0.575,0.675) -- (0.625,0.675);
        	\draw (0.6,0.7) node[right=6pt] {\color{black} \small analytical};
        	\draw (0.6,0.65) node[right=6pt] {\small mean};
        	\draw[color = nb, very thick,dotted] (0.575,0.565) -- (0.625,0.565);
        	\draw (0.6,0.59) node[right=6pt] {\color{black} \small simulation};
        	\draw (0.6,0.54) node[right=6pt] {\small mean};
    		\end{scope}
\end{tikzpicture}
